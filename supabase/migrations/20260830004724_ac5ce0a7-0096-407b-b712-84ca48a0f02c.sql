...
CREATE UNIQUE INDEX sentinel_sim_trades_user_client_key ON public.sentinel_sim_trades (user_id, client_key);
...
-- HARDENING: move the admin check into a private schema
