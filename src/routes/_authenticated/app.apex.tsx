...
function ApexPage() {
  ...
  // SINGLE RANK #1 — always the authoritative finalRank[0]. Never substituted by
  ...
  const handleScan = useCallback(() => {
    ...
    // The Scan winner is ALWAYS finalRank[0] — never the first qualified cell.
    const scanCandidate = result.finalRank?.[0] ?? result.best ?? null;
    if (scanCandidate) {
